...
#Many of the states are less populated. Around 3-4 countries have a population greater than 20 million
...
#The bar plot is a J shaped curve. It implies that many states have less than 10 million population (less population)
